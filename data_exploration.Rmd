...
<font color="red">TODO optional</font>
...
* n-grams (unigram, trigrams and 5-grams)

## Some tasks

<font color="red">TODO maybe not necessary</font>
...
<font color="red">TODO we need to define our entities since below are different from the dataset such as B-tvshow => TV show. We can ignore B-tvshow actually.</font>
...
<font color="red">TODO build classifiers</font>
...
```{r}
#tr <- train[train_ids,] # 70%
#te <- train[-train_ids,] # 30%

#control <- trainControl(method="cv", number=10)
#metric <- "Accuracy"

#set.seed(7)
#fit.knn <- train(V52 ~ ., data=tr, method="knn", metric=metric, trControl=control)

#lda.predict <- predict(fit.lda, te)
...
* [MUC-7](http://www-nlpir.nist.gov/related_projects/muc/)

<font color="red">TODO may need evaluation scripts.</font>
